...
<section class="content">
   <div class="box">
         ...
         <form method="post" action="{{ route('employee_factor.factor_achivement_credit_save_byemp', ['dept_id' => $dept_id, 'year' =>$year]) }}">
            ...
            <div class="col-sm-12" >
               <div class="col-sm-3" style="text-align: left; padding-left: 5px; padding-top:2px ">
                  <h4>Update Performance Score by Employees</h4>
               </div>
               <div class="col-sm-4">
      ...
      <td class="c_ac_width c_success"><input type="text" data-qids="qid_{{ $u->id }}_q1"  data-maximum="target[{{$u->id}}][3]" name="achived[{{$u->id}}][3]" value="{{ $u->achiveds[3] }}" class="form-control form-control-emptable mw80 validate_credit{{ $u->exceed }}"></td>
      ...
      <td class="c_ac_width c_success"><input type="text" data-qids="qid_{{ $u->id }}_q1" data-maximum="target[{{$u->id}}][4]"  name="achived[{{$u->id}}][4]" value="{{ $u->achiveds[4] }}" class="form-control form-control-emptable mw80 validate_credit{{ $u->exceed }}"></td>
      ...
      <td class="c_ac_width c_success"><input type="text" data-qids="qid_{{ $u->id }}_q1" data-maximum="target[{{$u->id}}][5]"   name="achived[{{$u->id}}][5]" value="{{ $u->achiveds[5] }}" class="form-control form-control-emptable mw80 validate_credit{{ $u->exceed }}"></td>
      ...
      <td class="c_ac_width c_success"><input type="text" data-qids="qid_{{ $u->id }}_q2" name="achived[{{$u->id}}][6]" data-maximum="target[{{$u->id}}][6]" value="{{ $u->achiveds[6] }}" class="form-control form-control-emptable mw80 validate_credit{{ $u->exceed }}"></td>
      ...
      <td class="c_ac_width c_success"><input type="text" data-qids="qid_{{ $u->id }}_q2" name="achived[{{$u->id}}][7]" data-maximum="target[{{$u->id}}][7]" value="{{ $u->achiveds[7] }}" class="form-control form-control-emptable mw80 validate_credit{{ $u->exceed }}"></td>
      ...
      <td class="c_ac_width c_success"><input type="text" data-qids="qid_{{ $u->id }}_q2" name="achived[{{$u->id}}][8]" data-maximum="target[{{$u->id}}][8]" value="{{ $u->achiveds[8] }}" class="form-control form-control-emptable mw80 validate_credit{{ $u->exceed }}"></td>
      ...
      <td class="c_ac_width c_success"><input type="text" data-qids="qid_{{ $u->id }}_q3" name="achived[{{$u->id}}][9]" data-maximum="target[{{$u->id}}][9]"  value="{{ $u->achiveds[9] }}" class="form-control form-control-emptable mw80 validate_credit{{ $u->exceed }}"></td>
      ...
      <td class="c_ac_width c_success"><input type="text" data-qids="qid_{{ $u->id }}_q3" name="achived[{{$u->id}}][10]" data-maximum="target[{{$u->id}}][10]"  value="{{ $u->achiveds[10] }}" class="form-control form-control-emptable mw80 validate_credit{{ $u->exceed }}"></td>
      ...
      <td class="c_ac_width c_success"><input type="text" data-qids="qid_{{ $u->id }}_q3" name="achived[{{$u->id}}][11]" data-maximum="target[{{$u->id}}][11]" value="{{ $u->achiveds[11] }}" class="form-control form-control-emptable mw80 validate_credit{{ $u->exceed }}"></td>
      ...
      <td class="c_ac_width c_success"><input type="text" data-qids="qid_{{ $u->id }}_q4" name="achived[{{$u->id}}][12]" data-maximum="target[{{$u->id}}][12]" value="{{ $u->achiveds[12] }}" class="form-control form-control-emptable mw80 validate_credit{{ $u->exceed }}"></td>
      ...
      <td class="c_ac_width c_success"><input type="text" data-qids="qid_{{ $u->id }}_q4" name="achived[{{$u->id}}][1]" data-maximum="target[{{$u->id}}][1]"  value="{{ $u->achiveds[1] }}" class="form-control form-control-emptable mw80 validate_credit{{ $u->exceed }}"></td>
      ...
      <td class="c_ac_width c_success"><input type="text" data-qids="qid_{{ $u->id }}_q4" name="achived[{{$u->id}}][2]" data-maximum="target[{{$u->id}}][2]" value="{{ $u->achiveds[2] }}" class="form-control form-control-emptable mw80 validate_credit{{ $u->exceed }}"></td>
      <td class="total-bg c_width c_warning"><input type="text" data-target-sum="qid_{{ $u->id }}_q4_max" name="target[{{$u->id}}][15]" readonly value="@isset($u->targets[15]){{$u->targets[15] }}@endisset" class="form-control form-control-emptable mw80 validate_credit{{ $u->exceed }}"></td>
