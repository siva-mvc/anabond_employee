...
@section('action-content')
  ...
  <div class="box-header">
    <div class="row">
        ...
        <div class="col-sm-4">
          <a class="btn btn-primary" href="{{ route('team.create') }}">Add new team</a>
        </div>
    </div>
  </div>
  <!-- /.box-header -->
  <div class="box-body">
      ...
      <form method="POST" action="{{ route('team.search') }}">
         {{ csrf_field() }}
                ...
                <tr role="row" class="odd">
                  ...
                  <td>
                    <form class="row" method="POST" action="{{ route('team.destroy', ['id' => $team->id]) }}" onsubmit = "return confirm('Are you sure?')">
                        ...
                        <a href="{{ route('team.edit', ['id' => $team->id]) }}" class="btn btn-warning col-sm-3 col-xs-5 btn-margin">
                        Update
                        </a>
